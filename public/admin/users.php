    ...
    <tbody>
      ...
      foreach ($rows as $row) {
        ...
        <tr>
          ...
          <td>
            <a href="delete_room.php?room_id=<?= $row["user_id"]; ?>" class="text-danger">
              <span class="fa fa-trash"></span>&nbsp;</a>
            &nbsp;
            /
            &nbsp;
            <a href="edit_room.php?room_id=<?= $row["user_id"]; ?>" class="text-success"> <span class="fa fa-pencil"></span></a>
          </td>
        </tr>
      <?php
      }
