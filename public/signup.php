          ...
          <form action="" id="signup_user" method="post" class="form">
            ...
            <div class="part part-1">
              <div class="form-group">
                ...
                <input type="tel" onfocus="fun()" name="user_phone" id="user_phone" class="form-control" placeholder="Enter your 11 digit phone number" />
              </div>
            ...
            <div class="part part-2">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="user_fname" id="user_fname" placeholder="Enter your first name" />
              </div>
              <div class="form-group">
                <label for="user_lname">Last name</label>
                <input type="text" class="form-control" name="user_lname" id="user_lname" placeholder="Enter your last name" />
              </div>
              <div class="form-group">
                <label for="user_dob">Date of birth</label>
                <input type="text" class="form-control" name="user_dob" id="user_dob" placeholder="Enter your birth date" />
              </div>
            ...
            <div class="part part-3">
              <div class="form-group">
                ...
                <input type="user_email" autocomplete="off" onkeyup="ValidateEmail()" name="user_email" id="user_email" placeholder="Enter your email" class="form-control" />
              ...
              <div class="form-group">
                <div class="step">
                  ...
                  <button type="submit" name="signup-user" id="signup-user" class="btn btn-primary">
                    Signup
                  </button>
                </div>
              </div>
  ...
  <script>
    ...
    function ValidateEmail() {
      ...
      if (email.match(mailformat)) {
        var span = document.getElementById("error_email");
        span.textContent = "";
      } else {
        var span = document.getElementById("error_email");
